                          ...
                          itemBuilder: (context, suggestion) {
                            return ITEMplaceAutoComplete(location: suggestion, width: 500,
                              onTap: () async {
                                ...
                                widget.location.firstText = suggestion.structuredFormatting!.mainText.toString();
                                widget.location.secondaryText = suggestion.structuredFormatting!.mainText.toString();
                                widget.location.LocationID = suggestion.placeId.toString();
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        if (widget.location.Latitude != 0 && widget.location.Longitude != 0) {
                          if (widget.location.firstText != '') {
                            locationcontrol.text = widget.location.firstText + ' ' + widget.location.secondaryText;
                            setState(() {
