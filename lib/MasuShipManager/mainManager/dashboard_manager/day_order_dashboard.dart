...
class day_order_dashboard extends StatefulWidget {
  const day_order_dashboard({super.key});

  @override
  State<day_order_dashboard> createState() => _day_order_dashboardState();
}

class _day_order_dashboardState extends State<day_order_dashboard> {
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    width: width - 70,
                    child: AutoSizeText(
                      'Thống kê ngày ' + DateTime.now().day.toString() + '/' + DateTime.now().month.toString() + '/' + DateTime.now().year.toString(),
                      style: TextStyle(
                        fontFamily: 'muli',
                        fontSize: 100,
