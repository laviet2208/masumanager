...
class view_log_catch_order extends StatefulWidget {
  ...
  const view_log_catch_order({Key? key, required this.order}) : super(key: key);

  @override
  State<view_log_catch_order> createState() => _view_log_catch_orderState();
}

class _view_log_catch_orderState extends State<view_log_catch_order> {
