...
class add_store_directory extends StatefulWidget {
  const add_store_directory({super.key});

  @override
  State<add_store_directory> createState() => _add_store_directoryState();
}

class _add_store_directoryState extends State<add_store_directory> {
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('Thêm danh mục shop', style: TextStyle(fontSize: 12),),
      content: Container(
