...
class item_store_in_directory extends StatefulWidget {
  ...
  final int index;
  final String shopId;
  const item_store_in_directory({super.key, required this.directory, required this.index, required this.shopId});
...
class _item_store_in_directoryState extends State<item_store_in_directory> {
  ...
  void change_directory(shopDirectory directory) {
    try {
      ...
      databaseRef.child('StoreDirectory').child(directory.id).set(directory.toJson());
    } catch (error) {
