...
import 'package:masumanager/MasuShipManager/mainManager/store_manager/actions/store_directory_actions/view_store_in_directory.dart';
import '../../../Data/accountData/shopData/shopDirectory.dart';

class item_store_directory extends StatefulWidget {
  final shopDirectory directory;
  final int index;
  const item_store_directory({super.key, required this.directory, required this.index});

  @override
  State<item_store_directory> createState() => _item_store_directoryState();
}

class _item_store_directoryState extends State<item_store_directory> {
  String area_name = "";
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: widget.directory.restaurantList.length.toString() + ' Shop', // Phần còn lại viết bình thường
                            style: TextStyle(
                              fontSize: 14,
                              fontFamily: 'muli',
                              fontWeight: FontWeight.normal, // Để viết bình thường
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return view_store_in_directory(directory: widget.directory);
                        },
                      );
                    },
                  )
