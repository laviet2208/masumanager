...
import 'package:masumanager/MasuShipManager/mainManager/store_manager/actions/free_store_actions/add_free_store.dart';
...
class free_store_manager extends StatefulWidget {
  const free_store_manager({super.key});

  @override
  State<free_store_manager> createState() => _free_store_managerState();
}

class _free_store_managerState extends State<free_store_manager> {
  ...
  void get_free_data() {
    ...
    reference.child("Store").orderByChild('discount_type').equalTo(2).onValue.listen((event) {
