...
import 'package:masumanager/MasuShipManager/mainManager/store_manager/actions/partner_store_actions/add_partner_store.dart';
import 'package:masumanager/MasuShipManager/mainManager/store_manager/store_manager_page/item_partner_store.dart';
import '../../../Data/accountData/shopData/shopAccount.dart';
import '../../../Data/areaData/Area.dart';

class partner_store_manager extends StatefulWidget {
  const partner_store_manager({super.key});

  @override
  State<partner_store_manager> createState() => _partner_store_managerState();
}

class _partner_store_managerState extends State<partner_store_manager> {
  TextEditingController searchController = TextEditingController();
  List<ShopAccount> restaurant_list = [];
  List<ShopAccount> chosenList = [];
  List<String> status_list = ['Thực phẩm', 'Rau củ', 'Mẹ và bé', 'Gia vị', 'Gia dụng', 'Đồ khô', 'Đồ hộp', 'Trứng sữa', 'Đồ nhậu'];
  String chosenStatus = '';
  ...
  void get_partner_data() {
    ...
    reference.child("Store").orderByChild('discount_type').equalTo(1).onValue.listen((event) {
          ...
          Positioned(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return item_partner_store(account: chosenList[index], index: index);
              },
            ),
          )
        ],
