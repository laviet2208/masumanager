  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () {
            if (NameControl.text.isNotEmpty && CostControl.text.isNotEmpty && NumberControl.text.isNotEmpty) {
              requestProduct product = requestProduct(name: NameControl.text.toString(), unit: UnitControl.text.isNotEmpty ? UnitControl.text.toString() : '', cost: double.parse(CostControl.text.toString()), number: double.parse(NumberControl.text.toString()));
