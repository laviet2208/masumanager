...
class change_food_cost extends StatefulWidget {
  final Product product;
  const change_food_cost({super.key, required this.product});

  @override
  State<change_food_cost> createState() => _change_food_costState();
}

class _change_food_costState extends State<change_food_cost> {
  bool loading = false;
