...
class item_food_directory extends StatefulWidget {
  final productDirectory directory;
  final ShopAccount account;
  final int index;
  const item_food_directory({super.key, required this.directory, required this.index, required this.account});

  @override
  State<item_food_directory> createState() => _item_food_directoryState();
}

class _item_food_directoryState extends State<item_food_directory> {
  @override
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return delete_food_directory(directory: widget.directory, account: widget.account);
                        },
                      );
                    },
                  ),
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return view_food_in_directory(directory: widget.directory, account: widget.account);
                        },
                      );
                    },
                  ),
