...
class add_partner_restaurant extends StatefulWidget {
  const add_partner_restaurant({super.key,});

  @override
  State<add_partner_restaurant> createState() => _add_partner_restaurantState();
}

class _add_partner_restaurantState extends State<add_partner_restaurant> {
  bool loading = false;
