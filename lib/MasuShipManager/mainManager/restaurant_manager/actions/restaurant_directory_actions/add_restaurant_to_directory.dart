...
class add_restaurant_to_directory extends StatefulWidget {
  final shopDirectory directory;
  const add_restaurant_to_directory({super.key, required this.directory});

  @override
  State<add_restaurant_to_directory> createState() => _add_restaurant_to_directoryState();
}

class _add_restaurant_to_directoryState extends State<add_restaurant_to_directory> {
  String query = '';
  ...
  void get_restaurant_data() {
    ...
    reference.child("Restaurant").orderByChild('area').equalTo(widget.directory.area).onValue.listen((event) {
