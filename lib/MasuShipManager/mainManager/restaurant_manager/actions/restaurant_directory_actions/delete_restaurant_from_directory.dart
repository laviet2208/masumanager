...
class delete_restaurant_from_directory extends StatefulWidget {
  final String deleteId;
  final shopDirectory directory;
  const delete_restaurant_from_directory({super.key, required this.deleteId, required this.directory});

  @override
  State<delete_restaurant_from_directory> createState() => _delete_restaurant_from_directoryState();
}

class _delete_restaurant_from_directoryState extends State<delete_restaurant_from_directory> {
  bool loading = false;
