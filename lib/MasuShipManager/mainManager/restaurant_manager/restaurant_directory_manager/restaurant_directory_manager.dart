...
import 'package:masumanager/MasuShipManager/mainManager/restaurant_manager/restaurant_directory_manager/item_restaurant_directory.dart';
import '../../../Data/areaData/Area.dart';
import '../actions/restaurant_directory_actions/add_restaurant_directory.dart';

class restaurant_directory_manager extends StatefulWidget {
  const restaurant_directory_manager({super.key});

  @override
  State<restaurant_directory_manager> createState() => _restaurant_directory_managerState();
}

class _restaurant_directory_managerState extends State<restaurant_directory_manager> {
            ...
            child: GestureDetector(
              ...
              onTap: () {
                showDialog(
                  context: context,
                  builder: (context) {
                    return add_restaurant_directory();
                  },
                );
              },
            ),
            ...
            child: directoryList != 0 ? Container(
              child: ListView.builder(
                ...
                itemBuilder: (context, index){
                  return item_restaurant_directory(directory: chosenList[index], index: index);
                },
              ),
