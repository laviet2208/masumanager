...
import 'package:masumanager/MasuShipManager/mainManager/restaurant_manager/actions/free_restaurant_actions/add_free_restaurant.dart';
import '../../../Data/accountData/shopData/shopAccount.dart';
import '../../../Data/areaData/Area.dart';
import 'item_partner_restaurant.dart';

class free_restaurant_manager extends StatefulWidget {
  const free_restaurant_manager({super.key});

  @override
  State<free_restaurant_manager> createState() => _free_restaurant_managerState();
}

class _free_restaurant_managerState extends State<free_restaurant_manager> {
  ...
  void get_free_data() {
    ...
    reference.child("Restaurant").orderByChild('discount_type').equalTo(2).onValue.listen((event) {
