...
import 'package:masumanager/MasuShipManager/mainManager/restaurant_manager/actions/partner_restaurant_actions/edit_actions/lock_unlock_partner.dart';
import 'package:masumanager/MasuShipManager/mainManager/restaurant_manager/actions/partner_restaurant_actions/food_directory_manager/food_directory_manager.dart';
import 'package:masumanager/MasuShipManager/mainManager/restaurant_manager/actions/partner_restaurant_actions/food_manager/food_manager.dart';
import '../../../Data/accountData/shopData/shopAccount.dart';
import '../../../Data/otherData/Tool.dart';
import '../actions/partner_restaurant_actions/edit_actions/edit_location_area.dart';
import '../actions/partner_restaurant_actions/edit_actions/edit_open_close_time.dart';
import '../actions/partner_restaurant_actions/edit_actions/edit_partner_name_phone_pass.dart';

class item_partner_restaurant extends StatefulWidget {
  final ShopAccount account;
  final int index;
  const item_partner_restaurant({super.key, required this.account, required this.index});

  @override
  State<item_partner_restaurant> createState() => _item_partner_restaurantState();
}

class _item_partner_restaurantState extends State<item_partner_restaurant> {
  List<String> type_list = ['5 sao','Ăn vặt','Bún phở','Cơm','Khuyến mãi','Món nhậu','Nước uống','Thức ăn nhanh','Trà sữa'];
  String area_name = '';
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return food_directory_manager(account: widget.account);
                        },
                      );
                    },
                  ),
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return food_manager(account: widget.account);
                        },
                      );
                    },
                  ),
